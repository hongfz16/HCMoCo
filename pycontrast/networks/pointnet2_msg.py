...
class Pointnet2MSG(nn.Module):
    def __init__(self, input_channels=6, class_num=1):
        super().__init__()
        ...
        # cls_layers.append(pt_utils.Conv1d(pre_channel, self.class_num, activation=None))
