...
num_samples=400
tag=ntusegrgbd2s_hrnet_w18_pn2_second_stage
ngpu=8
pretrain=./output/cmc_ntusegrgbd2s_model/CMCRGBD2S_HRNetPN_RGBD2S_Jig_False_bank_aug_C_linear_0.07_ntusegrgbd2s_official_hrnet_w18_pn2_norm_depth_v2_cosine/ckpt_epoch_100.pth
srun -p dsta \
