...
num_samples=400
tag=ntusegrgbd2s_hrnet_w18_sup_rgb_cmc1_other1
ngpu=4
pretrain=./output/cmc_ntusegrgbd2s_model/CMCRGBD2S_HRNet_RGBD2S_Jig_False_bank_aug_C_linear_0.07_ntusegrgbd2s_official_hrnet_w18_norm_depth_v2_mask_seg_depth_cosine/ckpt_epoch_100.pth
srun -p dsta \
